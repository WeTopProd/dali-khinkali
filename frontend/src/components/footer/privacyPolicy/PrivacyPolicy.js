      ...
      <div className="PrivacyPoliceContainer _container" id="privacyPolicy">
        ...
        <div className="PrivacyBox">
          ...
          <p>
            ...
            действующие от имени ООО "ЭКОСТАР", которые организуют и (или)
            ...
            (URL): https://ДАЛИ-ХИНКАЛИ .ru/, а также его субдоменах.
        ...
        <div className="PrivacyBox">
          ...
          <p>
            ...
            на странице по адресу: https://ДАЛИ-ХИНКАЛИ .ru/policy
          </p>
        </div>
      </div>
      <Footer />
