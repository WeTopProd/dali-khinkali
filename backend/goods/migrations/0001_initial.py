    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('hot_dishes', 'Горячие блюда'), ('salads', 'Салаты'), ('side_dishes', 'Гарниры'), ('dessert', 'Десерты'), ('drinks', 'Напитки'), ('khachapuri', 'Хачапури'), ('ossetian_pies', 'Осетинские пироги'), ('sauces', 'Соусы'), ('dishes_grill', 'Блюда на мангале'), ('beer_snacks', 'Пивные закуски'), ('bread', 'Хлеб'), ('snacks', 'Закуски'), ('soups', 'Супы'), ('business_lunch', 'Бизнес ланч')], max_length=50, null=True, verbose_name='Тип блюда')),
                ('promotion', models.CharField(blank=True, choices=[('new_items', 'Новинки')], max_length=50, null=True, verbose_name='Акция блюда')),
            ],
            options={
                'verbose_name': 'Блюдо',
